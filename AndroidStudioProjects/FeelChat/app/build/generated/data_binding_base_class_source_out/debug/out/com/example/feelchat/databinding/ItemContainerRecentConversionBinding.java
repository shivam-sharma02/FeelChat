...
public final class ItemContainerRecentConversionBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textRecentMessaage;
  ...
  private ItemContainerRecentConversionBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView textRecentMessaage, @NonNull View viewSupporter) {
    this.rootView = rootView;
    this.imageProfile = imageProfile;
    this.textName = textName;
    this.textRecentMessaage = textRecentMessaage;
  ...
  public static ItemContainerRecentConversionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textRecentMessaage;
      TextView textRecentMessaage = ViewBindings.findChildViewById(rootView, id);
      if (textRecentMessaage == null) {
        break missingId;
      }
      ...
      return new ItemContainerRecentConversionBinding((ConstraintLayout) rootView, imageProfile,
          textName, textRecentMessaage, viewSupporter);
    }
